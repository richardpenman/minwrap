...
class Wrapper:
    def __init__(self):
        self.data = [
            ('zaragoza', ['AUTOSALDUBA, S.A.', 'Avenida Cataluña, 105', 'autosalduba@kia.es', 'http://autosalduba.com', '976577644', '976465577', 'AUTOSALDUBA, S.A.', 'Avenida San José, 58', 'autosalduba@kia.es', 'http://autosalduba.com']),
            ('andorra', ['BECIER VEHICLES, S.A.U', 'Avenida d\'Enclar, 142', 'AD500', 'becier-posventa@kia.es', 'http://www.dealershipdomain.com', '376871820', 'BECIER VEHICLES, S.A.U', 'Avenida d\'Enclar, 31', 'becier@kia.es', 'http://www.dealershipdomain.com']),
